...
Mas há uma brecha estrutural: o indivíduo que percorre o Paêbirú pode se tornar *mais capaz* de ver a teia de relações — e essa capacidade pode virar vantagem, poder, potencial de falsidade refinada. O iluminado que usa sua iluminação para dominar.
...
### A Aporia Universal: Verdadeiro ou Falso

Cada um dos 21 passos apresenta sua aporia específica — tensão dialética que não pode ser resolvida, apenas habitada. Ação ou análise. Voz interior ou autoridade externa. Armadura ou abertura. E assim por diante.

Mas há uma **aporia universal** que atravessa todas as outras: **verdadeiro ou falso**.

Esta é a tensão entre:
- O **autêntico** — quem habita o arquétipo de forma genuína
- O **falso** (o picareta) — quem imita o arquétipo para obter vantagem

O guerreiro pode ser autêntico (age com coragem) ou falso (usa a aparência de coragem para dominar). O místico pode ser autêntico (toca o sagrado) ou falso (monopoliza o acesso ao transcendente). O cuidador pode ser autêntico (nutre) ou falso (cria dependência para controlar).

A Dimensão do 22º não combate o falso diretamente. Ela o torna **estruturalmente impossível**.
...
Cada arquétipo recebe cinco elementos na Dimensão do 22º:
...
Cada seção deve ser inserida ao final do arquétipo correspondente, após "A Ponte".
...
Cada passo apresentou sua aporia específica. Mas a aporia universal — **verdadeiro ou falso** — atravessou todas. Em cada arquétipo, a tensão entre o autêntico e o picareta se manifestou de forma diferente:

- O Guerreiro falso age no escuro; o autêntico age a céu aberto
- O Eremita falso implanta vozes; o autêntico ensina a discernir
- O Vulnerável falso explora aberturas; o autêntico cria campos de segurança
- O Místico falso monopoliza o sagrado; o autêntico democratiza o acesso
- O Caos Criativo falso monopoliza a improvisação; o autêntico distribui a dança

E assim por diante, em cada face.

A Dimensão do 22º não combateu o falso diretamente. Ela o tornou **estruturalmente impossível**. Quando todos vêem, não há onde se esconder. Quando todos criam sentido próprio, o mercado de sentidos fabricados colapsa. Quando todos podem improvisar, o monopólio da flexibilidade acaba.

**O picareta não é derrotado por combate. Ele é tornado obsoleto por estrutura.**

A luz não luta contra a escuridão. Ela a torna geometricamente impossível.
